...
export function IconOpenLink(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <path
        fill="currentColor"
        d="M4.7 19.3q-.275-.275-.275-.7t.275-.7L15.6 7H10q-.425 0-.713-.288T9 6q0-.425.288-.713T10 5h8q.425 0 .713.288T19 6v8q0 .425-.288.713T18 15q-.425 0-.713-.288T17 14V8.4L6.075 19.325Q5.8 19.6 5.4 19.6t-.7-.3Z"
      ></path>
    </svg>
  );
}
...
export function IconOpenNew(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
