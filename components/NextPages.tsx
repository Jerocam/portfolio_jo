  ...
  return (
    <div
      className={classNames(
        ...
        "flex mb-5 mt-5 sm:mt-0 sm:mb-10 w-full text-neutral-600 dark:text-neutral-300 text-sm md:text-base lg:text-xl font-medium"
      )}
    >
      <Link href={prev} className={classNames(!prev ? "hidden" : "visible")}>
        <span className="flex items-center hover:text-neutral-900 dark:hover:text-white transition-all">
          <IconArrowLeft className="mr-2 text-2xl md:text-2xl lg:text-4xl" />
          Previous
        </span>
      </Link>
      <Link href={nxt} className={classNames(!nxt ? "hidden" : "visible")}>
        <span className="flex items-center hover:text-neutral-900 dark:hover:text-white transition-all">
          Next
          <IconArrowRight className="ml-2 text-2xl md:text-2xl lg:text-4xl" />
        </span>
      </Link>
    </div>
  );
